...
3.
I also made one based on TWRP 12.1-13 , I made it cause I use lineage OS 20 which is Android 13 so I thought there may be a problem so I used

fastboot flash recovery <twrpa13.img>

4.
If it didn't work neither to you , here is the stock recovery file
